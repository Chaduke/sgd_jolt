...
//! Set entity rotation in world space, reversed and in radians
SGD_API void SGD_DECL sgd_SetEntityRotationQuat(SGD_Entity entity, SGD_Real rx, SGD_Real ry, SGD_Real rz, SGD_Real rw);
